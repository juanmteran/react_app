                    ...
                    <div className='col-12 col-md-9'>
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type='text' id='telnum' name='telnum' placeholder=' Telephone Number' value={this.state.telnum} onChange={this.handleInputChange}></Input>
                                </Col>
                            </FormGroup>
                            <FormGroup row>
                                <Label htmlfor='email' md={2}>E-Mail</Label>
                                <Col md={10}>
                                    <Input type='text' id='email' name='email' placeholder=' E-Mail' value={this.state.email} onChange={this.handleInputChange}></Input>
                                </Col>
                            </FormGroup>
                            <FormGroup row>
